class InstrumentsController < ApplicationController
  ...
  def index
    @instruments = current_user.instruments.all.order("created_at desc")
  end
  ...
  private
    ...
    def instrument_params
      params.require(:instrument).permit(:brand, :image_cache,:model, :description, :condition, :finish, :title, :price,:image )
    end
end
